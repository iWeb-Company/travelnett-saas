...
export default function ModalOptions({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-2 sm:p-4">
      <div
        className={`flex min-w-0 flex-col gap-3 sm:gap-6 w-full ${maxW} max-h-[90dvh]`}>
        {/* Recuadro azul con título e inputs */}
        <div
          className={`bg-skyblue min-w-0 rounded-2xl py-5 px-3 sm:py-8 sm:px-6 shadow-lg overflow-y-auto`}>
